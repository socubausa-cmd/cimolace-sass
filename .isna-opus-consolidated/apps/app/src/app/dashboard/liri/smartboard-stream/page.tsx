...
export default function SmartBoardStreamPage() {
  ...
  return (
    <main className="min-h-screen bg-[#040812] text-white">
      <div className="min-h-screen bg-[radial-gradient(50%_40%_at_50%_0%,rgba(124,58,237,0.22),transparent_70%),radial-gradient(35%_35%_at_85%_80%,rgba(6,182,212,0.14),transparent_70%),linear-gradient(180deg,#060d1d,#050914)] p-3">
        ...
        <header className="mb-3 flex items-center justify-between rounded-[18px] border border-white/10 bg-[#050b18]/85 px-4 py-3 backdrop-blur-xl">
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="rounded-full border border-violet-400/35 bg-violet-500/20 px-2 py-0.5 text-[10px] text-violet-100">LIVE</span>
            </div>
        ...
        <div className="grid h-[calc(100vh-94px)] grid-cols-[280px_1fr_340px] gap-3.5">
          <div className="space-y-3">
            ...
            <div className="rounded-[16px] border border-white/10 bg-black/20 p-3">
              ...
              <div className="h-2 overflow-hidden rounded-full bg-white/10">
                <div className="h-full rounded-full bg-gradient-to-r from-violet-500 to-cyan-400" style={{ width: `${progressPct}%` }} />
              </div>
              ...
              <div className="flex gap-2 overflow-x-auto">
                {chapterSlides.map((slide, idx) => (
                  ...
                  >
                    ...
                    <p className="mt-1 text-[10px] text-cyan-200/70">{slide.status || slide.state || 'waiting'}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="space-y-3">
            <div className="rounded-[16px] border border-violet-400/20 bg-violet-500/10 p-3">
