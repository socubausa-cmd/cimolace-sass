    ...
    try {
      const [pRes, sRes, wRes] = await Promise.all([
        supabase
          ...
          .select('id,created_at,provider,payment_method,purchase_type,formation_id,order_id,payment_status,price_amount,price_currency,pay_amount,pay_currency,user_id,provider_license_key,provider_license_expires_at,license_activated_at')
