...
function tCvPro() {
  return [
    ...
    mkText(ML, MT + 130, 420, 14, '[Poste occupé] — [Entreprise]',
      { fontSize: 11, fontWeight: 700, fill: '#1e293b', lineHeight: 1 }),
...
function smartCanvasBlocks() {
  ...
  return [
    mkRect(ML, MT,         CW, 60, zoneStyle('#22d3ee')),
    mkText(ML, MT + 22,    CW, 16, 'ZONE EN-TÊTE',       labelStyle('#22d3ee')),
    mkRect(ML, MT + 70,    CW, 34, zoneStyle('#8b5cf6')),
    mkText(ML, MT + 81,    CW, 14, 'ZONE TITRE / OBJET', labelStyle('#8b5cf6')),
    mkRect(ML, MT + 114,   CW, 490, zoneStyle('#34d399')),
    mkText(ML, MT + 350,   CW, 16, 'ZONE CORPS DU DOCUMENT', labelStyle('#34d399')),
