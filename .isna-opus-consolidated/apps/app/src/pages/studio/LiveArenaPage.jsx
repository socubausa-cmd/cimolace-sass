...
function PhaseScreen({ phase, error, sessionId, isHost, recoveryAsHost, joinCode }) {
  ...
  if (phase === PHASE.LOADING || phase === PHASE.CONNECTING) {
    return (
      <div className="fixed inset-0 bg-[#05070c] flex flex-col items-center justify-center gap-6">
        <div className="relative flex flex-col items-center gap-3 py-1">
          ...
          <div
            className="pointer-events-none absolute left-1/2 top-1/2 z-0 h-[min(24rem,88vw)] w-[min(24rem,88vw)] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#D4AF37]/18 animate-ping [animation-duration:2.25s]"
            aria-hidden
          />
          <motion.div
            ...
            className="relative z-10 h-16 w-16 rounded-2xl border border-[#D4AF37]/30 bg-[#0b1220]/85 p-2 shadow-[0_0_40px_-20px_rgba(212,175,55,0.55)]"
          >
            <img
          ...
          <div className="relative z-10 text-center">
            <div className="flex justify-center">
              <LiriWordmark size="compact" className="text-[#D4AF37]/85" />
            </div>
            <p className="text-[11px] text-white/45">Immersive Live Studio</p>
          </div>
        </div>
        <div className="relative">
          <div className="w-14 h-14 rounded-full border-2 border-[#D4AF37]/20 flex items-center justify-center">
          ...
          {joinCode ? (
            <div className="mt-4 flex flex-col items-center gap-2 px-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#D4AF37]/35 bg-[#D4AF37]/10 px-4 py-2 font-mono text-sm font-semibold tracking-wider text-[#F5E6C8] transition-colors hover:bg-[#D4AF37]/18"
              >
  ...
  if (phase === PHASE.ERROR) {
    return (
      <div className="fixed inset-0 bg-[#05070c] flex flex-col items-center justify-center gap-5 p-8">
        ...
        <Link
          ...
          className="mt-2 h-11 px-8 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/35 text-[#D4AF37] text-sm font-medium hover:bg-[#D4AF37]/30 flex items-center gap-2 transition-colors"
        >
  ...
  if (phase === PHASE.ENDED) {
    return (
      <motion.div
        ...
        className="fixed inset-0 bg-[#05070c] flex flex-col items-center justify-center gap-5"
      >
        ...
        <div className="text-center max-w-md px-4">
          ...
          {!isHost && (
            <div className="mt-5 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/lives"
                className="inline-flex h-11 px-8 rounded-full bg-[#D4AF37]/25 border border-[#D4AF37]/45 text-[#D4AF37] text-sm font-medium hover:bg-[#D4AF37]/35 items-center gap-2 transition-colors"
              >
                Voir directs & replays
              </Link>
              <Link
                to="/app"
                className="inline-flex h-11 px-8 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/30 text-[#D4AF37]/95 text-sm font-medium hover:bg-[#D4AF37]/25 items-center gap-2 transition-colors"
              >
                Accueil membre
              </Link>
            </div>
...
export default function LiveArenaPage() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#0a0908] overflow-hidden select-none">
                ...
                <div key={entry.id} className="px-4 py-3 space-y-2.5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    <button
                      ...
                      className="h-7 px-2 rounded-lg bg-[#D4AF37]/10 border border-[#D4AF37]/25 text-[#D4AF37] text-[10px] hover:bg-[#D4AF37]/20 transition-colors"
