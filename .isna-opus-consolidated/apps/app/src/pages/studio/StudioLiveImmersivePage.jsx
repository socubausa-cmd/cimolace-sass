...
export default function StudioLiveImmersivePage() {
  ...
  return (
    <div className="min-h-[calc(100dvh-5rem)] bg-[#090D14] text-white p-4 md:p-6">
      <div className="max-w-[1400px] mx-auto space-y-4">
        <div className="rounded-2xl border border-white/10 bg-[#0d1420]/75 backdrop-blur-xl px-4 py-3 flex flex-wrap items-center gap-3 justify-between">
          ...
          <div className="inline-flex flex-wrap items-center gap-2">
            ...
            <input
              ...
              className="h-9 w-52 rounded-xl bg-black/25 border border-white/10 px-3 text-xs outline-none focus:border-[#D4AF37]/35"
            />
            <SlideNavigator
              index={index}
              total={slides.length}
        ...
        <div className="rounded-2xl border border-[#D4AF37]/20 bg-[#0d1420]/80 px-4 py-4 space-y-3">
          <div className="flex items-center gap-2">
