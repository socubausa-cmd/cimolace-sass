        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link to="/ecoles/prorascience">
              <Button className="bg-[#D4AF37] text-black hover:bg-yellow-500 gap-2 h-11 px-6 font-semibold">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 pt-2 text-sm text-gray-500">
            ...
            <Link to="/ecoles/prorascience-apple-story" className="text-[#D4AF37]/90 hover:text-[#D4AF37] underline-offset-2 hover:underline">
              Récit Apple Story
            </Link>
            <span className="text-gray-700">·</span>
            <Link to="/ecoles/prorascience-apple-story-v3" className="text-[#D4AF37]/90 hover:text-[#D4AF37] underline-offset-2 hover:underline">
              Variante cinéma (V3)
            </Link>
            <span className="text-gray-700">·</span>
            <Link to="/ecoles/isna-pro" className="text-[#D4AF37]/90 hover:text-[#D4AF37] underline-offset-2 hover:underline">
              ISNA Pro
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pb-20 space-y-20">
        ...
        <section>
          <div className="text-center mb-10">
            <GraduationCap className="w-8 h-8 text-[#D4AF37] mx-auto mb-3" />
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeFilter === 'all' ? 'bg-[#D4AF37] text-black' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}
              >
                Toutes (21)
              </button>
              {cyclesData.map(c => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeFilter === String(c.number) ? 'bg-[#D4AF37] text-black' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}
                >
        ...
        <section className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-6">
            ...
            structuré en <span className="text-[#D4AF37] font-semibold">académie initiatique</span>,{' '}
            <span className="text-[#D4AF37] font-semibold">université spirituelle</span> et{' '}
            <span className="text-[#D4AF37] font-semibold">doctrine africaine souveraine</span>.
          </p>
