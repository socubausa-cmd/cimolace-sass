  ...
  return (
    <div className="min-h-screen bg-[#0F1419] text-white pt-24 pb-20">
      ...
      <section className="max-w-4xl mx-auto px-6">
         ...
         <div className="space-y-8 relative border-l-2 border-[#D4AF37]/20 pl-8 ml-4 md:ml-0">
            {[
               ...
               <div key={i} className="relative">
                  <div className="absolute -left-[41px] top-1 w-5 h-5 rounded-full bg-[#0F1419] border-2 border-[#D4AF37]"></div>
                  <span className="text-[#D4AF37] font-bold text-lg mb-1 block">{ev.year}</span>
