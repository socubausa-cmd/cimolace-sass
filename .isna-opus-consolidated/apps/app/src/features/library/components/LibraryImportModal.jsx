            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10">
                  <div
                    className={cn('h-full transition-all', isDone ? 'bg-emerald-500' : isError ? 'bg-red-500' : 'bg-[#D4AF37]')}
          ...
          {importJob?.preview && !isDone && !isError && (
            <div className="flex flex-col gap-2">
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-[12px] text-white/80 placeholder-white/25 outline-none focus:border-[#D4AF37]/30"
              />
              <input
                value={customTags}
        ...
        <div className="flex items-center justify-end gap-2 border-t border-white/8 px-5 py-3">
          {!isDone ? (
            ...
            <>
              ...
              <button onClick={onClose} className="flex items-center gap-1.5 rounded-lg bg-[#D4AF37] px-4 py-2 text-[12px] font-semibold text-black hover:bg-[#e5c448]">
