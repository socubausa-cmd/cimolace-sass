    ...
    <div className="flex flex-col gap-4 overflow-y-auto p-3">
      ...
      <Field label="Titre">
        <textarea
          ...
          rows={1}
          className="w-full resize-none rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-[12px] text-white/80 placeholder-white/25 outline-none focus:border-[#D4AF37]/40"
        />
      </Field>
