...
import { CimolaceAuthProvider } from '@/contexts/CimolaceAuthContext';
    ...
    <CimolaceAuthProvider>
      <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] text-white">Chargement...</div>}>
        <Routes>
          ...
          <Route path="admin" element={<CimolaceProtectedRoute><CimolaceAdminDashboard /></CimolaceProtectedRoute>} />
          <Route path="admin/clients" element={<CimolaceProtectedRoute><CimolaceAdminClients /></CimolaceProtectedRoute>} />
          <Route path="admin/clients/:id" element={<CimolaceProtectedRoute><CimolaceAdminClientDetail /></CimolaceProtectedRoute>} />
          <Route path="admin/sites" element={<CimolaceProtectedRoute><CimolaceAdminSites /></CimolaceProtectedRoute>} />
          <Route path="admin/billing" element={<CimolaceProtectedRoute><CimolaceAdminBilling /></CimolaceProtectedRoute>} />
          <Route path="admin/support" element={<CimolaceProtectedRoute><CimolaceAdminSupport /></CimolaceProtectedRoute>} />
