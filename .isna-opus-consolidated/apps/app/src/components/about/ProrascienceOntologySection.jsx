...
const SectionHeader = ({ title, subtitle, icon: Icon }) => (
  <div className="mb-10 text-center">
    {Icon && <div className="mx-auto w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center mb-4"><Icon className="w-6 h-6 text-[#D4AF37]" /></div>}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-yellow-200">Science Ontologique et Cosmologique</span>
          </h2>
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div key={i} className="bg-[#192734] p-6 rounded-xl border border-white/5 text-center hover:border-[#D4AF37]/30 transition-colors">
          ...
          <h4 className="text-xl font-bold text-white mb-6 pl-4 border-l-4 border-[#D4AF37]">Comparaison des Grands Modèles</h4>
          <FiveModelsTable />
        </div>
        ...
        <div className="mb-24">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-10">
            ...
            <div className="bg-[#192734] p-8 rounded-xl border border-white/10">
              ...
              <h4 className="text-white font-bold mb-4 flex items-center gap-2">
                <Brain className="text-[#D4AF37]" /> Apport Prorascientifique
              </h4>
              <p className="text-sm text-gray-400 italic border-l-2 border-[#D4AF37] pl-3">
        ...
        <div className="mb-24 flex flex-col md:flex-row gap-8 items-center bg-[#15202B] rounded-2xl p-8 border border-[#D4AF37]/20">
          <div className="md:w-1/3 text-center">
            <Globe className="w-24 h-24 text-[#D4AF37] mx-auto opacity-80" />
        ...
        <div className="mb-24 text-center">
           ...
           <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-sm font-bold text-white">
              ...
              <ArrowRightLeft className="text-[#D4AF37] w-6 h-6 rotate-90 md:rotate-0" />
              <div className="bg-[#D4AF37]/20 px-8 py-5 rounded-xl border border-[#D4AF37] scale-110 shadow-[0_0_20px_rgba(212,175,55,0.2)] w-full md:w-auto">
                PRORASCIENCE<br/><span className="text-[#D4AF37] font-normal">Ontologique / Holistique</span>
              </div>
              <ArrowRightLeft className="text-[#D4AF37] w-6 h-6 rotate-90 md:rotate-0" />
        ...
        <div className="max-w-4xl mx-auto bg-[#192734] rounded-xl p-8 border-l-4 border-[#D4AF37]">
          <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <Lightbulb className="text-[#D4AF37]" /> Implications pour l'Enseignement
          </h3>
