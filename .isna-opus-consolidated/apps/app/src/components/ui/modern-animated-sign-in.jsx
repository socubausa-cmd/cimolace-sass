 ...
 * Composant de connexion animé avec effets visuels
 * ═══════════════════════════════════════════════════════════════
 */
...
import { Eye, EyeOff, Code, Palette, Database, Globe, Server, Cpu, Layout, Layers, GitBranch } from 'lucide-react';
...
export function ModernAnimatedSignInDemo() {
  ...
  const iconsArray = [
    {
      component: () => <Code className="w-8 h-8 text-blue-500" />,
    ...
    {
      component: () => <Palette className="w-8 h-8 text-purple-500" />,
      className: 'size-[30px] border-none bg-transparent',
      duration: 20,
      delay: 10,
      radius: 100,
    ...
    {
      component: () => <Database className="w-12 h-12 text-green-500" />,
    ...
    {
      component: () => <Globe className="w-12 h-12 text-cyan-500" />,
      className: 'size-[50px] border-none bg-transparent',
      radius: 210,
      duration: 20,
      delay: 20,
    ...
    {
      component: () => <Server className="w-8 h-8 text-orange-500" />,
      className: 'size-[30px] border-none bg-transparent',
      duration: 20,
      delay: 20,
      radius: 150,
    ...
    {
      component: () => <Cpu className="w-8 h-8 text-red-500" />,
      className: 'size-[30px] border-none bg-transparent',
      duration: 20,
      delay: 10,
      radius: 150,
    ...
    {
      component: () => <Layout className="w-12 h-12 text-pink-500" />,
      className: 'size-[50px] border-none bg-transparent',
      radius: 270,
      duration: 20,
      path: false,
    ...
    {
      component: () => <Layers className="w-12 h-12 text-indigo-500" />,
      className: 'size-[50px] border-none bg-transparent',
      radius: 270,
      duration: 20,
      delay: 60,
    ...
    {
      component: () => <GitBranch className="w-12 h-12 text-yellow-500" />,
      className: 'size-[50px] border-none bg-transparent',
      radius: 320,
      duration: 20,
      delay: 20,
