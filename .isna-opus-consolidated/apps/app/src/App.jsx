...
function CimolaceDomainHandler() {
  ...
  useEffect(() => {
    ...
    // Apex + www : marque domaine → entrée produit Cimolace (pas l’ancienne home ISNA)
...
const AppContent = () => {
  ...
  const mobileReelsShellActive = useMobileReelsShellVisible();
    ...
    <div className={appShellClassName}>
      ...
      <main className={mainClassName}>
        ...
        <LazyChunkErrorBoundary>
          ...
          <Route path="/" element={<ProrascienceCommercialPage />} />
...
<Route path="/dev/smartboard-designer" element={
          ...
          {/* === PUBLIC FORMATIONS & PRICING === */}
          <Route path="/formations" element={<Navigate to="/forfaits" replace />} />
          ...
          <Route path="/catalogue" element={<Navigate to="/formations/catalogue" replace />} />
