...
export class StudioController {
  ...
  @Post('assets')
  createAsset(
    @Body() d: { assetType: string; title: string; publicUrl?: string; tags?: string[]; width?: number; height?: number; isTemplate?: boolean },
    @CurrentTenant() t: TenantContext,
    @Req() r: Request,
  ) {
  ...
  @Post('formations')
  createFormation(
    @Body() d: { title: string; programmeType?: string; audienceLevel?: string },
    @CurrentTenant() t: TenantContext,
    @Req() r: Request,
  ) {
  ...
  @Post('render-jobs')
  enqueueRenderJob(
    @Body() d: { workspaceId?: string; projectId?: string; jobType: string; exportFormat?: string },
    @CurrentTenant() t: TenantContext,
  ) {
