...
@Module({ imports: [SupabaseModule, TenantModule, MasterclassFactoryModule], providers: [CourseBuilderService], controllers: [CourseBuilderController], exports: [CourseBuilderService] })
