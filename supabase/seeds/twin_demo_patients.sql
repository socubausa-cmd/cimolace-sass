-- ════════════════════════════════════════════════════════════════════════
-- MEDOS v2 — Bio Digital Twin · SEED DÉMO (3 patients, profils contrastés)
-- Scores d'organes PRÉ-CALCULÉS par le moteur déterministe v1.
-- Tenant : zahirwellness (1896be98-0d36-4044-bf37-0f1a26f5c363). IDEMPOTENT : purge les démos puis réinsère.
-- ════════════════════════════════════════════════════════════════════════

-- Purge des patients démo précédents (cascade → biomarqueurs/scores/alertes/...).
DELETE FROM med_patients WHERE tenant_id = '1896be98-0d36-4044-bf37-0f1a26f5c363' AND last_name LIKE 'Démo-%';

DO $$
DECLARE pid uuid;
BEGIN
  INSERT INTO med_patients (tenant_id, patient_user_id, first_name, last_name, gender, date_of_birth, consent_given, status)
    VALUES ('1896be98-0d36-4044-bf37-0f1a26f5c363', gen_random_uuid(), 'Amina', 'Démo-Inflammatoire', 'female', '1979-04-12', true, 'active')
  ...
  INSERT INTO med_patient_biomarkers (tenant_id, patient_id, biomarker_code, value, unit_raw, flag, source) VALUES
      ...
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'HOMOCYSTEINE', 14, 'µmol/L', 'high', 'manual'),
  ...
  INSERT INTO med_organ_scores (tenant_id, patient_id, organ_code, score, color, dimensions, contributing_biomarkers, confidence) VALUES
      ...
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'heart', 34, 'red', '{"inflammation":46,"oxidative_stress":88}'::jsonb, '[{"code":"CRP_HS","name_fr":"CRP ultrasensible","value":8,"flag":"critical","penalty":30,"dimension":"inflammation"},{"code":"HOMOCYSTEINE","name_fr":"Homocystéine","value":14,"flag":"high","penalty":12,"dimension":"oxidative_stress"},{"code":"URIC_ACID","name_fr":"Acide urique","value":6.5,"flag":"high","penalty":12,"dimension":"inflammation"},{"code":"FIBRINOGEN","name_fr":"Fibrinogène","value":3.9,"flag":"high","penalty":12,"dimension":"inflammation"}]'::jsonb, 1),
      ...
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'immune', 0, 'red', '{"inflammation":0,"cellular_energy":70}'::jsonb, '[{"code":"CRP_HS","name_fr":"CRP ultrasensible","value":8,"flag":"critical","penalty":30,"dimension":"inflammation"},{"code":"ESR","name_fr":"Vitesse de sédimentation","value":25,"flag":"critical","penalty":30,"dimension":"inflammation"},{"code":"ANTI_TPO","name_fr":"Anticorps anti-TPO","value":60,"flag":"critical","penalty":30,"dimension":"inflammation"},{"code":"VIT_D","name_fr":"Vitamine D (25-OH)","value":24,"flag":"critical","penalty":30,"dimension":"cellular_energy"},{"code":"FERRITIN","name_fr":"Ferritine","value":280,"flag":"high","penalty":12,"dimension":"inflammation"},{"code":"FIBRINOGEN","name_fr":"Fibrinogène","value":3.9,"flag":"high","penalty":12,"dimension":"inflammation"}]'::jsonb, 1);

  INSERT INTO med_alerts (tenant_id, patient_id, kind, severity, message_fr, evidence, status) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'chronic_inflammation', 'warning', 'Signaux d''inflammation systémique (CRP + ferritine/VS). Rechercher la source inflammatoire.', '[{"code":"CRP_HS","value":8,"flag":"critical"},{"code":"FERRITIN","value":280,"flag":"high"},{"code":"ESR","value":25,"flag":"critical"}]'::jsonb, 'open'),
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'deficiency', 'info', 'Carence(s) possible(s) : VIT_D. À corréler aux symptômes.', '[{"code":"VIT_D","value":24,"flag":"critical"}]'::jsonb, 'open');
  ...
  INSERT INTO med_health_events (tenant_id, patient_id, event_type, title, occurred_at) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'illness', 'Poussée inflammatoire chronique', '2025-11-10');
END $$;
...
BEGIN
  INSERT INTO med_patients (tenant_id, patient_user_id, first_name, last_name, gender, date_of_birth, consent_given, status)
    VALUES ('1896be98-0d36-4044-bf37-0f1a26f5c363', gen_random_uuid(), 'Karim', 'Démo-Métabolique', 'male', '1972-09-03', true, 'active')
    RETURNING id INTO pid;
  ...
  INSERT INTO med_patient_biomarkers (tenant_id, patient_id, biomarker_code, value, unit_raw, flag, source) VALUES
      ...
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'INSULIN', 18, 'µUI/mL', 'high', 'manual'),
  ...
  INSERT INTO med_organ_scores (tenant_id, patient_id, organ_code, score, color, dimensions, contributing_biomarkers, confidence) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'heart', 0, 'red', '{"metabolism":0}'::jsonb, '[{"code":"TRIGLYCERIDES","name_fr":"Triglycérides","value":180,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"HDL","name_fr":"HDL cholestérol","value":35,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"LDL","name_fr":"LDL cholestérol","value":145,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"TG_HDL","name_fr":"Ratio TG/HDL","value":5.1,"flag":"critical","penalty":30,"dimension":"metabolism"}]'::jsonb, 1),
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'liver', 0, 'red', '{"metabolism":0,"hormones":88,"toxicity":76}'::jsonb, '[{"code":"GLUCOSE","name_fr":"Glycémie à jeun","value":110,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"HOMA_IR","name_fr":"HOMA-IR","value":3.2,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"TRIGLYCERIDES","name_fr":"Triglycérides","value":180,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"HDL","name_fr":"HDL cholestérol","value":35,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"LDL","name_fr":"LDL cholestérol","value":145,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"TG_HDL","name_fr":"Ratio TG/HDL","value":5.1,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"INSULIN","name_fr":"Insuline à jeun","value":18,"flag":"high","penalty":12,"dimension":"hormones"},{"code":"ALT","name_fr":"ALAT (SGPT)","value":50,"flag":"high","penalty":12,"dimension":"toxicity"},{"code":"GGT","name_fr":"Gamma-GT","value":60,"flag":"high","penalty":12,"dimension":"toxicity"}]'::jsonb, 1),
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'pancreas', 0, 'red', '{"metabolism":10,"hormones":88}'::jsonb, '[{"code":"GLUCOSE","name_fr":"Glycémie à jeun","value":110,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"HBA1C","name_fr":"Hémoglobine glyquée","value":6,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"HOMA_IR","name_fr":"HOMA-IR","value":3.2,"flag":"critical","penalty":30,"dimension":"metabolism"},{"code":"INSULIN","name_fr":"Insuline à jeun","value":18,"flag":"high","penalty":12,"dimension":"hormones"}]'::jsonb, 1);

  INSERT INTO med_alerts (tenant_id, patient_id, kind, severity, message_fr, evidence, status) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'metabolic_syndrome', 'warning', 'Faisceau évocateur d''un syndrome métabolique (résistance insulinique + dyslipidémie). À explorer cliniquement.', '[{"code":"HOMA_IR","value":3.2,"flag":"critical"},{"code":"TRIGLYCERIDES","value":180,"flag":"critical"},{"code":"HDL","value":35,"flag":"critical"},{"code":"HBA1C","value":6,"flag":"critical"}]'::jsonb, 'open'),
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'metabolic_risk', 'info', 'Indice de risque métabolique précoce (ratio TG/HDL ou glycémie). Surveillance recommandée.', '[{"code":"TG_HDL","value":5.1,"flag":"critical"},{"code":"GLUCOSE","value":110,"flag":"critical"}]'::jsonb, 'open');
  ...
  INSERT INTO med_health_events (tenant_id, patient_id, event_type, title, occurred_at) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'diet_change', 'Régime hyperglucidique prolongé', '2025-06-01');
END $$;
...
BEGIN
  INSERT INTO med_patients (tenant_id, patient_user_id, first_name, last_name, gender, date_of_birth, consent_given, status)
    VALUES ('1896be98-0d36-4044-bf37-0f1a26f5c363', gen_random_uuid(), 'Sophie', 'Démo-Thyroïde', 'female', '1986-02-21', true, 'active')
    RETURNING id INTO pid;
  ...
  INSERT INTO med_organ_scores (tenant_id, patient_id, organ_code, score, color, dimensions, contributing_biomarkers, confidence) VALUES
      ...
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'heart', 88, 'green', '{"cellular_energy":88}'::jsonb, '[{"code":"MAGNESIUM","name_fr":"Magnésium érythrocytaire","value":1.7,"flag":"low","penalty":12,"dimension":"cellular_energy"}]'::jsonb, 0.25),
  ...
  INSERT INTO med_alerts (tenant_id, patient_id, kind, severity, message_fr, evidence, status) VALUES
      ('1896be98-0d36-4044-bf37-0f1a26f5c363', pid, 'deficiency', 'warning', 'Carence(s) possible(s) : VIT_D, B12, FERRITIN, MAGNESIUM. À corréler aux symptômes.', '[{"code":"VIT_D","value":20,"flag":"critical"},{"code":"B12","value":280,"flag":"low"},{"code":"FERRITIN","value":25,"flag":"critical"},{"code":"MAGNESIUM","value":1.7,"flag":"low"}]'::jsonb, 'open');
