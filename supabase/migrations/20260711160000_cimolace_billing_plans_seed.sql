...
VALUES
  ...
  ((SELECT id FROM tenants WHERE slug='cimolace'), 'cimolace-medos-solo',   'MedOS — Solo',   'Notes SOAP + IA, ordonnances PDF, 50 patients, 20 consultations IA/mois.',        1900, 'EUR', 'monthly', 'cimolace-medos', 'Praticien solo',  22, true, NULL, '{"popular": true}'::jsonb),
