...
const SCORING: Record<string, Scored> = {
  ...
  transformes: { kind: 'ordinal', values: [95, 80, 55, 28, 10], life: ['inflammation', 'environment'], fn: ['glycation', 'oxidation', 'inflammation', 'biotransformation', 'methylation'] },
  ...
  grossesse: { kind: 'ordinal', values: [72, 58, 58, 66, 72], life: ['hormones'], fn: ['communication'] },
  transpiration: { kind: 'ordinal', values: [85, 48, 60, 32], life: [], fn: ['detoxification', 'transport'] },
  symptomes: { kind: 'signs', life: ['inflammation', 'immunity'], fn: ['defense', 'inflammation', 'structural'] },
