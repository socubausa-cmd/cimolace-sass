...
const ENGINE_DEFAULTS = {
  // MEDOS engine identity — used until tenant branding loads. The med-app
  // is "MEDOS-by-default, tenant-when-known" (Strategy C: 60% MEDOS, 40%
  // tenant) so the engine color stays visible even pre-fetch.
  name: 'MEDOS',
