...
import CimolaceRouter from './components/cimolace/CimolaceRouter';
...
function RootRedirect() {
  ...
  const isCimolacePublicHost =
    hostname === 'cimolace.space' ||
    hostname === 'www.cimolace.space' ||
    hostname.endsWith('-cimolace.vercel.app');

  return <Navigate to={isCimolacePublicHost ? '/cimolace' : '/dashboard'} replace />;
}
