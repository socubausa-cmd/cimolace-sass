  ...
  return (
    <div className={cn('flex flex-col gap-3 border-b border-white/[0.06] pb-4', className)}>
      <div className="flex items-center gap-2.5 px-0.5">
        <div
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-violet-400/40 bg-violet-500/[0.18] shadow-[0_0_20px_-4px_rgba(124,58,237,0.45)]"
          aria-hidden
        >
          <Brain className="h-6 w-6 text-violet-200/90" strokeWidth={1.25} />
        </div>
