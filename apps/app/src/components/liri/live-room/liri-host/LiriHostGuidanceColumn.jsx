  ...
  return (
    <div className={cn(LIRI_HOST_EVENT_CARD, 'flex min-h-0 flex-col overflow-hidden backdrop-blur-sm')}>
      ...
      >
        ...
        <ChevronDown
          className={cn(
            'h-4 w-4 shrink-0 text-[color-mix(in_srgb,var(--school-accent)_75%,transparent)] transition-transform duration-200',
            open && 'rotate-180',
          )}
        />
      </button>
...
export function LiriHostGuidanceColumn({
  ...
  return (
    ...
    >
      <div className="relative shrink-0 rounded-xl p-[1px] bg-gradient-to-br from-[color-mix(in_srgb,var(--school-accent)_38%,transparent)] via-amber-500/[0.22] to-[color-mix(in_srgb,var(--school-accent)_18%,transparent)] shadow-[0_0_44px_-14px_rgba(212,163,106,0.32),0_0_52px_-18px_rgba(212,175,55,0.2)]">
        <div className="relative overflow-hidden rounded-[11px] bg-[#0a0d14]/[0.96]">
          ...
          <div className="relative z-[1] p-1.5">
            <p
              className={cn(
                railTitleClass,
                'mb-1.5 px-0.5 text-[9px] font-semibold uppercase tracking-[0.14em] text-[color-mix(in_srgb,var(--school-accent)_85%,transparent)]',
              )}
            >
              Hôte en direct
            </p>
