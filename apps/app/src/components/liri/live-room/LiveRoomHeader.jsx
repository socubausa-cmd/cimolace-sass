...
export default function LiveRoomHeader({ stateLabel = '' }) {
  return (
    <div className="absolute top-4 left-4 z-30">
      <div className="h-11 px-4 rounded-full bg-white/[0.04] backdrop-blur-xl text-white border border-white/10 shadow-[0_8px_30px_-20px_rgba(255,187,120,0.6)] inline-flex items-center gap-2">
