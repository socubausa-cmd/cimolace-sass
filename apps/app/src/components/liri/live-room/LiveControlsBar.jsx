...
function ReactionsPopup({ onReact, onClose }) {
  return (
    <motion.div
      ...
      className="absolute bottom-14 left-1/2 -translate-x-1/2 z-50 flex flex-wrap items-center justify-center gap-1.5 max-w-[96vw] px-3 py-2 rounded-2xl border border-white/15 bg-[#0c1225]/95 backdrop-blur-xl shadow-2xl"
    >
      {REACTIONS.map((emoji) => (
        <button
          key={emoji}
