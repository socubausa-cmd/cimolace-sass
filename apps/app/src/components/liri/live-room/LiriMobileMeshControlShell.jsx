          ...
          >
            ...
            <div className="flex items-start justify-between gap-2 border-b border-white/[0.07] px-4 pb-3 pt-3">
              <div className="flex min-w-0 items-center gap-2.5">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-cyan-500/15 text-cyan-200">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
              {grantLabel ? (
                <div
                  className="mb-3 rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-3 py-2.5 text-center"
              ...
              <div className="flex flex-col gap-2.5">
                <button
                  ...
                  className={cn(
                    ...
                    canUseJoyKit
                      ? 'border-cyan-500/40 bg-cyan-500/12 text-cyan-100 active:scale-[0.99] hover:bg-cyan-500/18'
                ...
                <button
                  ...
                  className={cn(
                    'flex w-full items-center justify-center gap-2 rounded-2xl border px-4 py-3.5 text-[13px] font-bold transition',
                    canUseJoyKit
                      ? 'border-violet-500/40 bg-violet-500/12 text-violet-100 active:scale-[0.99] hover:bg-violet-500/18'
                      : 'cursor-not-allowed border-white/6 bg-white/[0.02] text-white/25',
                  )}
                >
                  Demander JoyKit
