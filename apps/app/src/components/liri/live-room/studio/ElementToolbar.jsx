      ...
      {ITEMS.map((item) => {
        ...
        return (
          <button
            ...
            className="h-9 px-3 rounded-xl border border-white/[0.12] bg-white/[0.04] text-gray-200 text-xs inline-flex items-center gap-1.5 hover:border-[color-mix(in_srgb,var(--school-accent)_30%,transparent)] hover:text-[var(--school-accent)]"
          >
