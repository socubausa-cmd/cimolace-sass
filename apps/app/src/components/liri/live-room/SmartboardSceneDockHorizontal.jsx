      ...
      <TooltipContent
        ...
        className={cn(
          ...
          premiumArenaHostTray
            ? 'border-amber-400/35 bg-[#0c0820]/[0.97] text-amber-50'
...
function dockChromeBtnClass(premiumArenaHostTray) {
  return cn(
    ...
    'border-white/[0.08] bg-[#14131c]/95 text-white/[0.52]',
    'shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]',
    premiumArenaHostTray
      ? 'hover:border-amber-400/35 hover:bg-[#16122a] hover:text-amber-100'
      : 'hover:border-amber-400/[0.32] hover:bg-[#1a1814] hover:text-amber-100/95',
...
const SceneThumbH = forwardRef(function SceneThumbH(
  ...
  const cls = cn(
    ...
    active
      ? premiumArenaHostTray
        ? 'border-amber-400/45 bg-gradient-to-b from-amber-500/[0.22] to-[#0c0a18] text-amber-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_0_16px_-10px_rgba(212,163,106,0.45)]'
        : 'border-amber-400/[0.42] bg-gradient-to-b from-amber-500/[0.18] to-[#14100c] text-amber-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_16px_-10px_rgba(245,158,11,0.3)]'
      : cn(
          'border-white/[0.07] bg-[#14131c]/90 text-white/[0.48]',
          'shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]',
          !readOnly &&
            (premiumArenaHostTray
              ? 'hover:border-amber-400/[0.28] hover:bg-[#16122a] hover:text-amber-100/90'
    ...
    <TooltipProvider delayDuration={200} skipDelayDuration={100}>
      <div
        className={cn(
          ...
          premiumArenaHostTray && 'border-amber-500/15 bg-[#14131c]/[0.92]',
        )}
        role="toolbar"
      ...
      >
        <Tooltip delayDuration={220}>
          ...
          <TooltipContent
            side="top"
            className="max-w-[220px] border border-white/[0.14] bg-[#0c0f16]/[0.97] px-2.5 py-1.5 text-left text-[10px] text-white/75"
          >
