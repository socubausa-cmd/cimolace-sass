...
const shellFrameClass =
  'pointer-events-none absolute inset-0 rounded-xl border border-[#D4AF37]/45 shadow-[inset_0_0_0_1px_rgba(212,175,55,0.22),0_0_14px_-6px_rgba(212,175,55,0.35)]';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex h-full flex-col items-center justify-center gap-0.5 px-1 pt-2 pb-4">
        <Plus className="h-3.5 w-3.5 text-[#D4AF37]/55" strokeWidth={2.25} aria-hidden />
        <span className="text-center text-[8px] font-medium leading-tight text-[#D4AF37]/70">
          En attente
        </span>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex h-full flex-col items-center justify-center gap-0 px-1 pt-2 pb-4">
        <Plus className="h-3 w-3 text-[#D4AF37]/65" strokeWidth={2.5} aria-hidden />
        <span className="font-serif text-[11px] font-semibold tabular-nums text-[#f5dd8a]">
          +{n}
        </span>
        <span className="text-[7px] font-medium uppercase tracking-[0.06em] text-[#D4AF37]/65">
          membres
        </span>
      </div>
    </div>
