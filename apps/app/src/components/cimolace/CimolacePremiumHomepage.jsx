      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        <motion.div variants={stagger} initial="hidden" animate="show">
          ...
          <motion.div variants={fadeUp} className="mt-10 flex flex-col sm:flex-row gap-3">
            <Link to="/cimolace/launch" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-violet-600 to-violet-500 px-6 py-4 text-sm font-black text-white hover:from-violet-700 hover:to-violet-600 transition-all shadow-lg shadow-violet-500/20">
              Lancer mon infrastructure
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/cimolace/login" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-6 py-4 text-sm font-black text-white hover:bg-white/[0.08] transition-colors">
