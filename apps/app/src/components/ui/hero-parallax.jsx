...
/**
 * HeroParallax — adapté pour Vite/React (sans next/image ni next/link).
 * Effet parallaxe 3D piloté au scroll (Aceternity UI).
 *
 * Props:
 *  - products: { title, link, thumbnail }[]  (idéalement 15 → 3 rangées de 5)
 *  - header?:  ReactNode  (en-tête custom ; sinon en-tête ISNA par défaut)
 */
