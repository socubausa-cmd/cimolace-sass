...
// RÉSERVÉ — à utiliser pour la section/page « Cours en ligne · application LIRI ».
// NON importé pour l'instant (stash). Adaptations à prévoir avant intégration :
//  - Tokens Tailwind v4 dans le CSS injecté (var(--color-foreground)) → mapper sur les vars v3 de apps/app (--foreground).
//  - Remplacer le contenu démo (Sobers / iPhone / App Store) par le contenu LIRI (cours, mockup app LIRI).
//  - gsap + ScrollTrigger : déjà présents dans apps/app (gsap ^3.12).
"use client";
