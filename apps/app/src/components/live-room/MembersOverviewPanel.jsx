    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div className="relative flex flex-col flex-1 min-h-0 border border-[#D4AF37]/20 bg-[#0c1018]/88 m-1 rounded-xl shadow-xl">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          'hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/8 transition-colors min-h-[120px]',
                        )}
                      >
                        <div className="flex-1 flex items-center gap-3 p-3 min-h-[88px]">
                          {m.avatar_url ? (
                            ...
                            <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-[#D4AF37]/28 to-[#1a2540] flex items-center justify-center text-sm font-bold text-[#D4AF37] flex-shrink-0 border border-white/10">
                              {initials}
                            </div>
                          )}
                        ...
                        <div className="px-3 py-1.5 border-t border-white/8 bg-white/[0.03] text-[9px] text-[#D4AF37]/90 text-center">
