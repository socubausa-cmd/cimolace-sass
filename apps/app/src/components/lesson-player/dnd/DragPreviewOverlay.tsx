...
export function DragPreviewOverlay({ activeId, panels }: DragPreviewOverlayProps) {
  ...
  return (
    ...
    >
      {panel && (
        <div className="w-56 rounded-xl border border-[color-mix(in_srgb,var(--school-accent)_60%,transparent)] bg-[#0d1b2a]/90 shadow-2xl backdrop-blur overflow-hidden pointer-events-none rotate-1 scale-105">
          <div className="flex items-center gap-2 px-3 py-2 bg-black/40 border-b border-white/10">
            <GripHorizontal className="w-3.5 h-3.5 text-[var(--school-accent)]" />
