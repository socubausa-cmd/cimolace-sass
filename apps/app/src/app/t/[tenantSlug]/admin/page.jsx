    ...
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <a href={`/t/${tenantSlug}/admin/members`} className="bg-white rounded-lg shadow p-4 hover:shadow-md transition">
            <h3 className="font-semibold mb-2">Membres &amp; invitations</h3>
            <p className="text-sm text-gray-600">Gérer les rôles et inviter des collaborateurs</p>
          </a>
