...
export default function OrchestratorLivePage() {
  ...
  const agents = [
    { name: 'Masterclass Coach', role: 'Analyse & Pédagogie', progress: 75, state: 'RUNNING', task: 'Construction du chapitre 3', jobs: 12, errors: 0, remain: '2.1 min', color: 'from-[#d97757] to-[#e08a5f]' },
    { name: 'Visual Director', role: 'Direction Artistique', progress: 45, state: 'RUNNING', task: 'Visual map chapitre 2', jobs: 6, errors: 0, remain: '3.4 min', color: 'from-[#d4924a] to-[#e0a458]' },
    ...
    { name: 'Quality Agent', role: 'Validation Qualité', progress: 0, state: 'IDLE', task: 'En attente de slides', jobs: 4, errors: 0, remain: '—', color: 'from-[#5a8f52] to-[#e0a458]' },
  ];
      ...
      <div className="h-[100dvh] overflow-hidden bg-[radial-gradient(60%_40%_at_50%_0%,rgba(217,119,87,0.28),transparent_70%),radial-gradient(30%_35%_at_90%_80%,rgba(217,146,74,0.14),transparent_75%),linear-gradient(180deg,#1c1a16,#040812)] p-3">
        <div className="flex h-[calc(100dvh-24px)] overflow-hidden rounded-[22px] border border-white/10 bg-[#050914]/60 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.95)]">
          <aside className="flex h-full w-[230px] flex-col border-r border-white/10 bg-[#050a16]/92 p-3.5 backdrop-blur-xl">
            ...
            <div className="mt-7 rounded-2xl border border-[#e08a5f]/25 bg-[#d97757]/10 p-3">
              <p className="text-[10px] text-white/55">Projet actif</p>
              <div className="mt-2 rounded-xl border border-[#e8a97f]/20 bg-black/25 p-2.5">
                <div className="mb-2 h-12 rounded-lg border border-[#e8a97f]/15 bg-[radial-gradient(70%_70%_at_30%_30%,rgba(224,138,95,0.5),rgba(0,0,0,0))]" />
                <p className="text-xs font-semibold">demo_masterclass</p>
                <p className="mt-1 text-[10px] text-[#9cc48a]">● En cours</p>
              </div>
            </div>
            <div className="mt-auto rounded-2xl border border-white/10 bg-black/25 p-3">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-full bg-[#d97757]/30" />
                <div>
                  <p className="text-xs font-semibold">Coach LIRI</p>
                  <p className="text-[10px] text-[#9cc48a]">● En ligne</p>
                </div>
              </div>
          ...
          <div className="flex h-full min-w-0 flex-1 flex-col overflow-hidden p-3.5">
            ...
            <div className="grid min-h-0 flex-1 grid-cols-[1.58fr_0.92fr_1fr] gap-3 overflow-hidden">
              <section className="min-h-0 space-y-3 overflow-hidden">
                <div className="rounded-[18px] border border-white/10 bg-[#0b1020]/90 p-3.5">
                  ...
                  <div className="mt-3 h-9 rounded-lg border border-[#e08a5f]/20 bg-[radial-gradient(80%_80%_at_50%_0%,rgba(224,138,95,0.32),transparent_70%)]" />
                </div>
                    ...
                    {chapterRows.map((row) => (
                      <div key={row[0]} className="rounded-xl border border-white/10 bg-black/25 p-2.5">
                        <div className="mb-1 flex items-center justify-between">
                          ...
                          <span className="rounded-full bg-[#d97757]/15 px-2 py-0.5 text-[9px] text-[#f0c4b3]">{row[2]}</span>
                        </div>
                        <div className="mb-1 h-1.5 overflow-hidden rounded-full bg-white/10">
                          <div className="h-full rounded-full bg-gradient-to-r from-[#e08a5f] to-[#e0a458]" style={{ width: row[3] }} />
                        </div>
              ...
              <section className="min-h-0 space-y-3 overflow-hidden">
                <div className="rounded-[18px] border border-white/10 bg-[#0b1020]/90 p-4">
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    <div className="relative h-24 w-24 rounded-full border-4 border-[#d97757]/30 shadow-[0_0_22px_-10px_rgba(217,119,87,0.9)]">
                      <div className="absolute inset-0 rounded-full border-4 border-[#e6b566]" style={{ clipPath: `inset(${100 - completion}% 0 0 0)` }} />
              ...
              <aside className="min-h-0 space-y-3 overflow-hidden">
                  ...
                  <div className="max-h-[26vh] space-y-1.5 overflow-y-auto pr-1 text-[11px]">
                    {logs.map((line, i) => (
                      <p key={`${line}-${i}`} className="rounded-lg border border-white/10 bg-black/25 px-2 py-1.5 text-white/70">
                        <span className="mr-1 text-[#e8a97f]">•</span>{line}
                      </p>
                    ))}
                  </div>
                </div>
                <div className="rounded-[18px] border border-white/10 bg-[#0b1020]/90 p-3.5">
                  ...
                  <div className="relative h-44 rounded-xl border border-[#e08a5f]/20 bg-[radial-gradient(circle_at_50%_45%,rgba(217,119,87,0.35),transparent_45%)]">
                    <div className="absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 rounded-xl border border-[#e8a97f]/35 bg-[#d97757]/20" />
                    <div className="absolute inset-4 rounded-full border border-[#e0a458]/25" />
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-[10px] text-white/60">
                      <span className="flex items-center gap-1"><Circle size={8} className="fill-[#e08a5f] text-[#e08a5f]" />Coach</span>
                      <span className="flex items-center gap-1"><Circle size={8} className="fill-[#e0a458] text-[#e0a458]" />Visual</span>
                      <span className="flex items-center gap-1"><Circle size={8} className="fill-amber-400 text-amber-400" />Architect</span>
                      <span className="flex items-center gap-1"><Circle size={8} className="fill-[#7bb06a] text-[#7bb06a]" />Quality</span>
                    </div>
                  </div>
                </div>
              </aside>
            ...
            <div className="mt-3 flex shrink-0 items-center justify-between rounded-[16px] border border-white/10 bg-black/25 px-5 py-2.5 text-sm text-white/70">
              ...
              <div className="flex items-center gap-4 text-[12px]">
                <span className="text-[#9cc48a]">● API Connectée</span>
                <span className="text-[#e6b566]">● WebSocket Live</span>
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-2 rounded-xl border px-3 py-2 text-left ${
        active
          ? 'border-[#e08a5f]/40 bg-[#d97757]/20 text-[#f5d9cc]'
...
function Stat({ icon: Icon, value, label }: { icon: any; value: string; label: string }) {
  return (
    <div className="rounded-xl border border-white/10 bg-black/20 p-3.5">
      <Icon className="mb-2 text-[#e8a97f]" size={16} />
