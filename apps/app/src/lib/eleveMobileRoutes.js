...
export const ELEVE_MOBILE = {
  ...
  /** Inscription élève (coque LIRI mobile, sans sortir du shell). */
  signup: `${ELEVE_MOBILE_BASE}/signup`,
  ...
  /** Centre de notifications (coque LIRI mobile). */
  notifications: `${ELEVE_MOBILE_BASE}/notifications`,
