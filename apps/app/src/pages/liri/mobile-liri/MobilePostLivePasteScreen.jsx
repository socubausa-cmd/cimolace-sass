...
import { parseLiveSessionIdFromInput } from '@/pages/liri/mobile-liri/MobileArenaScreen';
    ...
    <LiriMobileScreenShell contentClassName="overflow-y-auto pb-8">
      ...
      <LiriGoldCard variant="subtle" className="mb-4 border-[color-mix(in_srgb,var(--school-accent)_22%,transparent)] p-4">
        ...
        <button
          ...
          disabled={!sessionId}
          onClick={go}
          className="mt-3 w-full min-h-11 rounded-2xl border border-[color-mix(in_srgb,var(--school-accent)_50%,transparent)] bg-[color-mix(in_srgb,var(--school-accent)_15%,transparent)] text-sm font-semibold text-[#f5e6c8] disabled:opacity-35 disabled:pointer-events-none"
        >
          Ouvrir la fiche
        </button>
      </LiriGoldCard>
