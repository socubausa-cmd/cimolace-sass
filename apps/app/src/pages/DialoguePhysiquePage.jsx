    ...
    <div className="min-h-screen bg-[#0F1419] text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 pb-20 space-y-16">
        ...
        <section id="ch1" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>C'est la <span className="text-[var(--school-accent)] font-semibold">contrainte ontologique</span>. L\'architecture relationnelle qui lie A, B et C dans le champ de permission. Avant que A et B se rencontrent — la loi de leur relation existait déjà.</Narrator>
        ...
        <section id="ch3" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Le vide quantique fluctue. Il n'est jamais à zéro. Il y a une énergie minimale irréductible. C\'est la <span className="text-[var(--school-accent)] font-semibold">Loi NZ</span> : aucun système réel ne peut atteindre zéro information, zéro distinction, zéro énergie.</Narrator>
          ...
          <Narrator>La QFT calcule l'énergie de <span className="text-white font-semibold">tous les qualia possibles</span> dans l\'onde ontologique — y compris ceux qui ne sont pas encore effondrés. Mais nous n\'observons que les qualia effectifs. <span className="text-[var(--school-accent)] font-semibold">La divergence vient de cette confusion entre l\'énergie du nuage total et l\'énergie de la pluie effective.</span></Narrator>
        ...
        <section id="ch4" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Inévitablement. Pas parce qu'une force le pousse. Parce que <span className="text-[var(--school-accent)] font-semibold">l\'équilibre parfait est ontologiquement instable</span>. La symétrie parfaite se détruit par sa propre logique.</Narrator>
        ...
        <section id="ch5" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Prorascience, si. C'est la <span className="text-[var(--school-accent)] font-semibold">Règle d\'Or</span>. Toute combinaison valide doit contenir une différenciation minimum entre ses composants. Ce n\'est pas une loi des fermions. C\'est une loi ontologique universelle.</Narrator>
        ...
        <section id="ch6" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Oui. Des qualia permis dans Φ, présents dans ψ, mais dont le différentiel Δ est insuffisant pour atteindre le seuil de manifestation. <span className="text-[var(--school-accent)] font-semibold">Elles ne sont pas cachées. Elles n'ont pas encore plu.</span></Narrator>
        ...
        <section id="ch7" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>La conscience est un cas particulier. Un qualia d'ordre suffisamment élevé pour non seulement atteindre le seuil ε — mais pour <span className="text-[var(--school-accent)] font-semibold">lire le champ de permission qui l\'a produit</span>.</Narrator>
          ...
          <Narrator>Ce que le système <span className="text-white font-semibold">garantit</span> : tu auras existé. Ta trace dans le Vibratinium est permanente. Le cosmos qui t'a produit a été modifié par le fait que tu as existé. <span className="text-[var(--school-accent)] font-semibold">Irréversiblement.</span></Narrator>
        ...
        <section id="ch8" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Les constantes physiques ne sont pas des règles arbitraires. Ce sont les <span className="text-[var(--school-accent)] font-semibold">murs de ce cosmos spécifique</span> — les limites de ce que le Potentia Prima de notre effondrement permet.</Narrator>
        ...
        <section id="ch9" className="space-y-4 scroll-mt-28">
          ...
          <Narrator>Chaque effondrement a gravé une trace dans le Vibratinium. Pour que la tasse se recompose, il faudrait effacer cette trace — ce qui violerait la Loi d'Irréversibilité. La physique dit : trop improbable. Prorascience dit : <span className="text-[var(--school-accent)] font-semibold">impossible en principe</span>.</Narrator>
        ...
        <section id="epilogue" className="space-y-5 scroll-mt-28">
          <div className="flex items-center gap-3">
            ...
            <div><span className="text-xs text-[var(--school-accent)] font-bold uppercase tracking-wider">Épilogue</span><h2 className="text-2xl md:text-3xl font-serif font-bold text-white">La Science comme Lecture du Fond</h2></div>
          </div>
