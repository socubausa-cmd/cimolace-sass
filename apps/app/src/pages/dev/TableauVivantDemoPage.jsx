...
/**
 * Démo SANS AUTH du « Tableau Vivant » — /dev/tableau-vivant
    ...
    <div className="min-h-screen bg-[#0b0f17] px-4 py-8 md:py-12" style={{ '--school-accent': '#d4a36a' }}>
      <div className="mx-auto max-w-3xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-xs text-white/40">Révélation progressive cadencée comme une narration. La vraie voix off (TTS) = Lot 1 du CDC.</p>
        </div>
