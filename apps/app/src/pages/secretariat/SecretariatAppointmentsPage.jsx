...
const STATUS_CONFIG = {
  ...
  preparing:    { label: 'Préparation',   dot: 'bg-[#d97757]',    ring: 'border-[#d97757]    bg-[#d97757]'    },
  ready:        { label: 'Prêt ✓',       dot: 'bg-[#d97757]',  ring: 'border-[#d97757]  bg-[#d97757]',  pulse: true },
  ...
  live_started: { label: 'Live',          dot: 'bg-[#d97757]',  ring: 'border-[#d97757]  bg-[#d97757]',  pulse: true },
