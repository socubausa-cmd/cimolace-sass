...
import { EV_LINE, EV_MUTED, EV_SH } from '@/pages/eleve-mobile/eleveMobileScreensShared';
import { cn } from '@/lib/utils';

export { EV_BG, EV_PAGE_AMBIENT, EV_R, EV_SH, EV_ACCENT, EV_MUTED, EV_LINE } from '@/pages/eleve-mobile/eleveMobileScreensShared';
