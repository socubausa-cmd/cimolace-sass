...
export default function StudioLiveLabPage() {
  ...
  return (
    <div
      className="min-h-screen premium-dashboard-shell p-6 pb-20 text-white"
      data-school-shell="studio-live-lab"
          ...
          {CARDS.map((c, i) => (
            ...
            >
              <Link to={c.to} className="group block">
                <div className="premium-panel h-full p-6 transition-all hover:-translate-y-1 hover:border-[color:var(--school-accent)]">
