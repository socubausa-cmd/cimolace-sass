          ...
          <div className="space-y-4">
            {communities.map((item, i) => (
              <motion.button
                ...
                className="w-full rounded-xl border border-white/10 bg-[#151a21]/80 backdrop-blur-xl p-6 flex items-center justify-between hover:border-[#D4AF37]/30 hover:bg-[#151a21] transition-all text-left"
              >
