...
export default function CimolacePressPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white px-6 py-16">
      <Helmet>
        <title>Presse | {cimolacePlatformConfig.productName}</title>
        <meta name="description" content="Presse CIMOLACE." />
      </Helmet>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="mt-6 text-3xl md:text-4xl font-black tracking-tight">Presse</h1>
        <p className="mt-4 text-white/70">
          Stub. Kit média, communiqués, logos, contacts presse.
        </p>
