...
const DEFAULT_FORM = {
  ...
  favicon_url: '',
  contact_email: '',
  // ⛔ NE PAS REPEINDRE : couleurs de MARQUE envoyées à /provision-school,
  // pas des styles d'écran. L'interdit navy/or vise le back-office, pas un client.
  primary: '#0b1115',
  secondary: '#162331',
  accent: '#d4af37',
...
export default function CimolaceAdminSchoolProvisioning() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#262624', color: '#f5f4ee', colorScheme: 'dark', display: 'flex', flexDirection: 'column' }}>
      <CimolaceHeader />
...
const thStyle = {
  ...
  color: '#f5f4ee',
  backgroundColor: '#262624',
  borderBottom: '1px solid rgba(245,244,238,.09)',
  padding: '10px 12px',
  whiteSpace: 'nowrap',
};
...
const dangerButtonStyle = (disabled) => ({
  ...
  borderRadius: '8px',
  border: 'none',
  backgroundColor: disabled ? 'transparent' : 'rgba(179,55,47,.16)',
  color: '#f5f4ee',
  fontWeight: 700,
  cursor: disabled ? 'not-allowed' : 'pointer',
});
...
const emptyStyle = {
  ...
  color: '#a8a49a',
  backgroundColor: '#262624',
  border: '1px dashed rgba(245,244,238,.16)',
  borderRadius: '8px',
  padding: '18px',
  fontSize: '14px',
};
...
const pillStyle = {
  display: 'inline-flex',
  borderRadius: '999px',
  backgroundColor: 'rgba(217,119,87,.14)',
  color: '#d97757',
  padding: '5px 9px',
  fontSize: '12px',
  fontWeight: 700,
