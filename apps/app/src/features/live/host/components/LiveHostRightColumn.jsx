        ...
        <>
          {((isGuestUi && !lhStageFocusLayout) || focusHost) && phase === PHASE.LIVE ? (
            <button
              ...
              className="pointer-events-auto absolute right-2 top-2 z-[32] flex h-8 w-8 items-center justify-center rounded-lg border border-white/[0.12] bg-[#262624]/90 text-white/65 shadow-sm backdrop-blur-sm transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white/90"
