              ...
              {phase === PHASE.LIVE && (
                <button
                  ...
                  style={{
                    ...
                    zIndex: 25,
                    borderRadius: '10px',
                    border: `1px solid ${neuronQActive ? 'rgba(200,148,62,.5)' : 'rgba(255,255,255,.12)'}`,
                    background: neuronQActive ? 'rgba(200,148,62,.18)' : 'rgba(0,0,0,.5)',
                    backdropFilter: 'blur(8px)',
                    padding: '6px 12px',
                    fontSize: '10px',
                    fontWeight: 700,
                    color: neuronQActive ? '#d4a36a' : 'rgba(255,255,255,.78)',
                    cursor: 'pointer',
                    letterSpacing: '.04em',
                  }}
                >
