...
const infrastructures = [
  { icon: "🏫", name: "École", tag: "Formations, lives, certifications", status: "available" as const, gradient: "from-indigo-400 to-purple-400" },
  { icon: "🏥", name: "MedOS", tag: "Dossiers patients, IA médicale", status: "available" as const, gradient: "from-emerald-400 to-teal-400" },
  { icon: "🌿", name: "Bien-être", tag: "Coaching, programmes, suivis", status: "beta" as const, gradient: "from-green-400 to-emerald-400" },
  { icon: "🎬", name: "Créateur", tag: "Studio, monétisation, VOD", status: "beta" as const, gradient: "from-pink-400 to-rose-400" },
  { icon: "🛒", name: "Mbolo", tag: "E-commerce Afrique", status: "coming-soon" as const, gradient: "from-orange-400 to-amber-400" },
  { icon: "🕌", name: "Temple", tag: "Spiritualité, cérémonies", status: "coming-soon" as const, gradient: "from-amber-400 to-yellow-400" },
  { icon: "👥", name: "Communauté", tag: "Forums, événements", status: "coming-soon" as const, gradient: "from-cyan-400 to-blue-400" },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
          {infrastructures.map((infra, i) => (
            <Link key={infra.name} href={infra.name === "MedOS" ? "/medos" : "/pricing"}>
