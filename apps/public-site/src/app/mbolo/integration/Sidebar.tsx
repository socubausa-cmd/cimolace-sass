...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "#auth", label: "Authentification (clé API)" },
      { href: "#prix", label: "Prix & devises" },
    ],
  },
  {
    group: "API Storefront",
    items: [
      { href: "#endpoint-categories", label: "GET /categories" },
      { href: "#endpoint-products", label: "GET /products" },
      { href: "#endpoint-product", label: "GET /products/:slug" },
      { href: "#endpoint-orders", label: "POST /orders (checkout)" },
    ],
  },
  {
    group: "Production",
