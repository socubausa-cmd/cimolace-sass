...
@Module({
  ...
  providers: [MasterclassFactoryService, TranscriptCourseService, CourseJobService, ReplayChaptersService],
  controllers: [MasterclassFactoryController, PrecepteurLibraryController],
  exports: [MasterclassFactoryService, TranscriptCourseService, CourseJobService, ReplayChaptersService],
})
