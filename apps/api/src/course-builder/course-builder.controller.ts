...
export class CourseBuilderController {
  ...
  @Post('postprod-version-save') saveVersion(@Body() d: any, @CurrentTenant() t: TenantContext, @Req() r: Request) { return this.svc.saveVersion(t, ((r as any).user?.id as string) ?? '', d ?? {}); }
