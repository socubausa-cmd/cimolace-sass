...
@Module({ imports: [SupabaseModule, TenantModule, AiUtilsModule], providers: [CourseBuilderService], controllers: [CourseBuilderController], exports: [CourseBuilderService] })
