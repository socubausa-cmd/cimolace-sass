...
**Manque restant (⇒ nécessite USER)** :
- **E2E « write » complet** (créer une VRAIE org → activer → payer une VRAIE transaction) = écrit en prod → **exige accord USER explicite** ; ensuite ancrer en CI + nettoyer les données test.
